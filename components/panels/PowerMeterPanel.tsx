...
export default function PowerMeterPanel({ usage }: PowerMeterPanelProps) {
  ...
  return (
    <div className="border-2 border-line rounded-lg bg-canvas p-4 flex flex-col justify-between h-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-4.5">
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* Active Demand */}
          <div className="border border-line bg-canvas/40 p-2.5 rounded">
                ...
                <div key={roomKey} className="space-y-1">
                  <div className="flex justify-between items-baseline text-xs">
                    <span className="font-sans font-medium text-ink uppercase tracking-wide text-[11px]">
                      {roomNames[roomKey as keyof typeof roomNames] || roomKey}
                    </span>
